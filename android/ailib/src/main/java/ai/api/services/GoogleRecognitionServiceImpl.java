...
public class GoogleRecognitionServiceImpl extends AIService {
    ...
    private void sendRequest(@NonNull final String query, @NonNull final AIRequest aiRequest, @Nullable final RequestExtras requestExtras) {
        if (aiRequest == null) {
        ...
        public void onResults(final Bundle results) {
            if (recognitionActive) {
                ...
                if (recognitionResults == null || recognitionResults.isEmpty()) {
                    ...
                    sendRequest(recognitionResults.get(0), aiRequest, requestExtras);
                }
            }
            stopInternal();
        }
